 ...
 * @param {number} a The lower limit of the range. Included in possible returns.
 * @param {number} b The upper limit of the range. Excluded.
 * @return {number} Floating-point number chosen randomly in the range.
 */
 ...
 */
var Enemy = function(name, imageURL) {
